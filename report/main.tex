...
\dlaiauthor{Barbalata Radu Ionut - 2002688}{}
\end{dlaiauthorlist}

\dlaicorrespondingauthor{Barbalata Radu Ionut - 2002688}{barbalata.2002688@studenti.uniroma1.it}
...
Full run-level summaries, three-repetition ranges and accuracy breakdowns are
available in \path{docs/results.md}; arena/Triton microbenchmarks are in
\path{docs/generated/arena_triton/} at the repository URL above.
...
The core research ideas, project scope, and experimental design were my own.
OpenAI Codex was used as an engineering assistant during development to help
with code prototyping—specifically the Triton INT8 kernel, experiment runners,
and test suite—as well as code refactoring and plot generation scripts. Codex was
also used for technical proofreading and editing of this report. All reported
measurements come from experiments executed on hardware, and all generated
code, data analysis, and final written content were integrated, debugged, and
verified for correctness by the author.
